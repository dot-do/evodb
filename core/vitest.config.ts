...
export default defineWorkersConfig({
  test: {
    ...
    alias: {
      ...
      '../streaming-executor.js': resolve(__dirname, 'src/streaming-executor.ts'),
      ...
      '../schemas.js': resolve(__dirname, 'src/schemas.ts'),
      '../validation.js': resolve(__dirname, 'src/validation.ts'),
      '../backup.js': resolve(__dirname, 'src/backup.ts'),
      '../import-export.js': resolve(__dirname, 'src/import-export.ts'),
