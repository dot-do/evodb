...
[EvoDB API Reference](../../../README.md) / [query/src](../README.md) / R2Range

# Interface: R2Range

Defined in: [query/src/types.ts:1473](https://github.com/dot-do/evodb/blob/main/query/src/types.ts#L1473)
...
Defined in: [query/src/types.ts:1474](https://github.com/dot-do/evodb/blob/main/query/src/types.ts#L1474)
...
Defined in: [query/src/types.ts:1475](https://github.com/dot-do/evodb/blob/main/query/src/types.ts#L1475)
